...
router.put("/:id", _util.isAuth, _util.isAdmin, (0, _expressAsyncHandler.default)(async (req, res) => {
...
router.post("/", _util.isAuth, _util.isAdmin, (0, _expressAsyncHandler.default)(async (req, res) => {
...
router.post("/:id/reviews", _util.isAuth, (0, _expressAsyncHandler.default)(async (req, res) => {
...
router.get("/categories", (0, _expressAsyncHandler.default)(async (req, res) => {
